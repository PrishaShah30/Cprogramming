	...
	if (strcmp(args[1], "programmingLanguages") == 0)
	{
		for (int i = 0; i < lang_m.count; i++)
		{
			if (programmingLanguages[i].id == atoi(args[2]))
			{
				...
				programmingLanguages[lang_m.nextIndex].language = (char *)malloc(strlen(args[4])+1);
				...
				programmingLanguages[lang_m.nextIndex].creator = (char *)malloc(strlen(args[6])+1);
				strcpy(programmingLanguages[lang_m.nextIndex].creator, args[6]);

				free(programmingLanguages[lang_m.nextIndex].paradigm);
				programmingLanguages[lang_m.nextIndex].paradigm = (char *)malloc(strlen(args[7])+1);
	...
	else if (strcmp(args[1], "operatingSystems") == 0)
	{
		for (int i = 0; i < os_m.count; i++)
		{
			if (operatingSystems[i].id == atoi(args[2]))
			{
				...
				operatingSystems[os_m.nextIndex].name = (char *)malloc(strlen(args[4])+1);
				...
				operatingSystems[os_m.nextIndex].developer = (char *)malloc(strlen(args[6])+1);
				strcpy(operatingSystems[os_m.nextIndex].developer, args[6]);

				free(operatingSystems[os_m.nextIndex].kernelType);
				operatingSystems[os_m.nextIndex].kernelType = (char *)malloc(strlen(args[7])+1);
